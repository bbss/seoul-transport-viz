...
(_core.log.deprecated("thresholdValue","threshold")(),threshold=opts.thresholdValue);opts=0>x;var isRightBoundary=x>=width-1,isBottomBoundary=0>y,isTopBoundary=y>=height-1;height=opts||isRightBoundary||isBottomBoundary||isTopBoundary;if(opts||isTopBoundary)var JSCompiler_object_inline_top_6594=0;else{var JSCompiler_object_inline_top_6590=cellWeights[(y+1)*width+x];JSCompiler_object_inline_top_6594=getVertexCode(JSCompiler_object_inline_top_6590,threshold)}if(isRightBoundary||isTopBoundary)isTopBoundary=
0;else{var JSCompiler_object_inline_topRight_6591=cellWeights[(y+1)*width+x+1];isTopBoundary=getVertexCode(JSCompiler_object_inline_topRight_6591,threshold)}if(isRightBoundary||isBottomBoundary)isRightBoundary=0;else{var JSCompiler_object_inline_right_6592=cellWeights[y*width+x+1];isRightBoundary=getVertexCode(JSCompiler_object_inline_right_6592,threshold)}if(opts||isBottomBoundary)x=0;else{var JSCompiler_object_inline_current_6593=cellWeights[y*width+x];x=getVertexCode(JSCompiler_object_inline_current_6593,
threshold)}cellWeights=JSCompiler_object_inline_top_6594;y=isTopBoundary;width=isRightBoundary;opts=x;x=-1;Number.isFinite(threshold)&&(x=cellWeights<<3|y<<2|width<<1|opts);Array.isArray(threshold)&&(x=cellWeights<<6|y<<4|width<<2|opts);cellWeights=0;height||(cellWeights=getVertexCode((JSCompiler_object_inline_top_6590+JSCompiler_object_inline_topRight_6591+JSCompiler_object_inline_right_6592+JSCompiler_object_inline_current_6593)/4,threshold));return{code:x,meanCode:cellWeights}};exports.getVertices=
