...
this.eventManager!==_options$eventManager&&(this.eventManager=_options$eventManager,this._events={},this.toggleEvents(this.events,!0));this.toggleEvents(JSCompiler_object_inline_WHEEL_6493,_options$isInteractiv&&_options$scrollZoom);this.toggleEvents(JSCompiler_object_inline_PAN_6494,_options$isInteractiv&&(_options$dragPan||_options$dragRotate));this.toggleEvents(JSCompiler_object_inline_PINCH_6495,_options$isInteractiv&&(_options$touchZoom||_options$touchRotate));this.toggleEvents(JSCompiler_object_inline_DOUBLE_TAP_6496,
_options$isInteractiv&&_options$doubleClickZ);this.toggleEvents(JSCompiler_object_inline_KEYBOARD_6497,_options$isInteractiv&&_options$keyboard);this.scrollZoom=_options$scrollZoom;this.dragPan=_options$dragPan;this.dragRotate=_options$dragRotate;this.doubleClickZoom=_options$doubleClickZ;this.touchZoom=_options$touchZoom;this.touchRotate=_options$touchRotate;this.keyboard=_options$keyboard}},{key:"toggleEvents",value:function(eventNames,enabled){var _this2=this;this.eventManager&&eventNames.forEach(function(eventName){if(_this2._events[eventName]!==
