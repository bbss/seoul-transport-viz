...
function findNativeHandler(_ref){var start=_ref.start,current=_ref.current,anchor=_ref.anchor,JSCompiler_object_inline_scrollPosition_6671={x:"scrollLeft",y:"scrollTop"},JSCompiler_object_inline_scrollLength_6672={x:"scrollWidth",y:"scrollHeight"},JSCompiler_object_inline_clientLength_6673={x:"clientWidth",y:"clientHeight"};return _ref.domTreeShapes.some(function(shape){var goingForward=current>=start;if("top"===anchor||"left"===anchor)goingForward=!goingForward;var axis="left"===anchor||"right"===
anchor?"x":"y",scrollPosition=shape[JSCompiler_object_inline_scrollPosition_6671[axis]];axis=scrollPosition+shape[JSCompiler_object_inline_clientLength_6673[axis]]<shape[JSCompiler_object_inline_scrollLength_6672[axis]];return goingForward&&axis||!goingForward&&0<scrollPosition?shape:null})}var _interopRequireWildcard=require("module$node_modules$$babel$runtime$helpers$interopRequireWildcard"),_interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,
...
domTreeShapes=[]:(0<element.clientWidth&&element.scrollWidth>element.clientWidth||0<element.clientHeight&&element.scrollHeight>element.clientHeight)&&domTreeShapes.push(element);element=element.parentElement}if(element=findNativeHandler({domTreeShapes:domTreeShapes,start:horizontalSwipe?swipeInstance.current.startX:swipeInstance.current.startY,current:horizontalSwipe?currentX:anchorRtl,anchor:anchor})){nodeThatClaimedTheSwipe=element;return}nodeThatClaimedTheSwipe=swipeInstance.current}if(null==swipeInstance.current.isSwiping&&
