...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__100401){
var vec__100403 = p__100401;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100403,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100403,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__100433,args){
var vec__100434 = p__100433;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100434,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100434,(1),null);
...
var vec__100441 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100441,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100441,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__100456,sym){
var map__100460 = p__100456;
var map__100460__$1 = (((((!((map__100460 == null))))?(((((map__100460.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__100460.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__100460):map__100460);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100460__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100460__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__100474,sym){
var map__100477 = p__100474;
var map__100477__$1 = (((((!((map__100477 == null))))?(((((map__100477.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__100477.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__100477):map__100477);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100477__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100477__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
