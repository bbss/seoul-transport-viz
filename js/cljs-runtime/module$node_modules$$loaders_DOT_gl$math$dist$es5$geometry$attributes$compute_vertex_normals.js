...
Object.defineProperty(exports,"__esModule",{value:!0});exports["default"]=function(_ref){var mode=_ref.mode,indices=_ref.indices,attributes=_ref.attributes;(0,_assert["default"])((0,_modes.getPrimitiveModeType)(mode)===_constants.GL.TRIANGLES,"TRIANGLES required");_ref=(0,_getAttributeFromGeometry.getPositions)({mode:mode,indices:indices,attributes:attributes}).values;var normals=new Float32Array(_ref.length),vectorA=new _core.Vector3,vectorB=new _core.Vector3,vectorC=new _core.Vector3,vectorCB=new _core.Vector3,
vectorAB=new _core.Vector3;mode=_createForOfIteratorHelper((0,_primitiveIterator["default"])({mode:mode,indices:indices,attributes:attributes}));var _step;try{for(mode.s();!(_step=mode.n()).done;){var primitive=_step.value;vectorA.fromArray(_ref,3*primitive.i1);vectorB.fromArray(_ref,3*primitive.i2+3);vectorC.fromArray(_ref,3*primitive.i3+6);vectorCB.subVectors(vectorC,vectorB);vectorAB.subVectors(vectorA,vectorB);var normal=vectorCB.cross(vectorAB);normal.normalize();var primitiveIndex=primitive.primitiveIndex;
...
_assert=global(require("module$node_modules$$loaders_DOT_gl$math$dist$es5$geometry$utils$assert")),_primitiveIterator=global(require("module$node_modules$$loaders_DOT_gl$math$dist$es5$geometry$iterators$primitive_iterator")),_modes=require("module$node_modules$$loaders_DOT_gl$math$dist$es5$geometry$primitives$modes"),_getAttributeFromGeometry=require("module$node_modules$$loaders_DOT_gl$math$dist$es5$geometry$attributes$get_attribute_from_geometry")}
