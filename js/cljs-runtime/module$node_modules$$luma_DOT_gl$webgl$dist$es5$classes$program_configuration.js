...
name,compositeType,size){compositeType=(0,_attributeUtils.decomposeCompositeGLType)(compositeType);size={type:compositeType.type,size:size*compositeType.components};this._inferProperties(location,name,size);name={location:location,name:name,accessor:new _accessor["default"](size)};this.attributeInfos.push(name);this.attributeInfosByLocation[location]=name;this.attributeInfosByName[name.name]=name}},{key:"_inferProperties",value:function(location,name,accessor){/instance/i.test(name)&&(accessor.divisor=
1)}},{key:"_addVarying",value:function(location,name,compositeType,size){compositeType=(0,_attributeUtils.decomposeCompositeGLType)(compositeType);size=new _accessor["default"]({type:compositeType.type,size:size*compositeType.components});location={location:location,name:name,accessor:size};this.varyingInfos.push(location);this.varyingInfosByName[location.name]=location}}]);return ProgramConfiguration}();exports["default"]=require}
