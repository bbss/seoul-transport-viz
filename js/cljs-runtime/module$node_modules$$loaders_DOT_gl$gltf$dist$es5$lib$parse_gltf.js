...
promises=[];options$jscomp$0.gltf.loadImages&&(_promise=loadImages(gltf$jscomp$0,options$jscomp$0,context),promises.push(_promise));if(!options$jscomp$0.gltf.loadBuffers){_context.next=9;break}_context.next=9;return loadBuffers(gltf$jscomp$0,options$jscomp$0,context);case 9:return promise=(0,_gltfExtensions.decodeExtensions)(gltf$jscomp$0,options$jscomp$0,context),promises.push(promise),_context.next=13,Promise.all(promises);case 13:return _context.abrupt("return",options$jscomp$0.gltf.postProcess?
(0,_postProcessGltf["default"])(gltf$jscomp$0,options$jscomp$0):gltf$jscomp$0);case 14:case "end":return _context.stop()}},_callee)}));return _parseGLTF.apply(this,arguments)}function loadBuffers(_x3,_x4,_x5){return _loadBuffers.apply(this,arguments)}function _loadBuffers(){_loadBuffers=(0,_asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(gltf,options,context){var i,buffer,fetch,uri,response,arrayBuffer;return _regenerator["default"].wrap(function(_context2){for(;;)switch(_context2.prev=
_context2.next){case 0:i=0;case 1:if(!(i<gltf.json.buffers.length)){_context2.next=18;break}buffer=gltf.json.buffers[i];if(!buffer.uri){_context2.next=15;break}fetch=context.fetch;(0,_assert["default"])(fetch);uri=(0,_resolveUrl.resolveUrl)(buffer.uri,options);_context2.next=9;return fetch(uri);case 9:return response=_context2.sent,_context2.next=12,response.arrayBuffer();case 12:arrayBuffer=_context2.sent,gltf.buffers[i]={arrayBuffer:arrayBuffer,byteOffset:0,byteLength:arrayBuffer.byteLength},delete buffer.uri;
case 15:++i;_context2.next=1;break;case 18:case "end":return _context2.stop()}},_callee2)}));return _loadBuffers.apply(this,arguments)}function loadImages(_x6,_x7,_x8){return _loadImages.apply(this,arguments)}function _loadImages(){_loadImages=(0,_asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3(gltf,options,context){var images,promises,i;return _regenerator["default"].wrap(function(_context3){for(;;)switch(_context3.prev=_context3.next){case 0:images=gltf.json.images||
[];promises=[];for(i=0;i<images.length;++i)promises.push(loadImage(gltf,images[i],i,options,context));_context3.next=5;return Promise.all(promises);case 5:return _context3.abrupt("return",_context3.sent);case 6:case "end":return _context3.stop()}},_callee3)}));return _loadImages.apply(this,arguments)}function loadImage(_x9,_x10,_x11,_x12,_x13){return _loadImage.apply(this,arguments)}function _loadImage(){_loadImage=(0,_asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee4(gltf,
...
_parseGlb=global(require("module$node_modules$$loaders_DOT_gl$gltf$dist$es5$lib$parse_glb")),_postProcessGltf=module(require("module$node_modules$$loaders_DOT_gl$gltf$dist$es5$lib$post_process_gltf"))}
