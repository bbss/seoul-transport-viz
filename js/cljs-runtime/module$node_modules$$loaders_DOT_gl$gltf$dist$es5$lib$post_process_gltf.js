...
COMPONENTS[accessor.type];accessor.bytesPerElement=accessor.bytesPerComponent*accessor.components;if(accessor.bufferView){index=accessor.bufferView.buffer;var _getAccessorArrayType=(0,_gltfUtils.getAccessorArrayTypeAndLength)(accessor,accessor.bufferView);accessor.value=new _getAccessorArrayType.ArrayType(index.arrayBuffer,(accessor.bufferView.byteOffset||0)+index.byteOffset,_getAccessorArrayType.length)}return accessor}},{key:"_resolveTexture",value:function(texture,index){texture.id=texture.id||
