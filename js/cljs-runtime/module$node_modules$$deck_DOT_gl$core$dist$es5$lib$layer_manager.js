...
this._initializeLayer(newLayer),generatedLayers.push(newLayer),newLayers=newLayer.isComposite&&newLayer.getSubLayers()}catch(err){this._handleError("matching",err,newLayer)}newLayers&&this._updateSublayersRecursively(newLayers,oldLayerMap,generatedLayers)}}catch(err$419){_didIteratorError6=!0,_iteratorError6=err$419}finally{try{if(!_iteratorNormalCompletion6&&null!=_iterator6["return"])_iterator6["return"]()}finally{if(_didIteratorError6)throw _iteratorError6;}}}},{key:"_finalizeOldLayers",value:function(oldLayerMap){for(var layerId in oldLayerMap){var layer=
