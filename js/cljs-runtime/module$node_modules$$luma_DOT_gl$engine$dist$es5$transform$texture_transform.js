...
10242,33071),(0,_defineProperty2["default"])(_SRC_TEX_PARAMETER_OV,10243,33071),_SRC_TEX_PARAMETER_OV);require=function(){function TextureTransform(gl){var props=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};(0,_classCallCheck2["default"])(this,TextureTransform);this.gl=gl;this.currentIndex=0;this.samplerTextureMap=this.targetTextureType=this.targetTextureVarying=this._swapTexture=null;this.bindings=[];this.resources={};this._initialize(props);Object.seal(this)}(0,_createClass2["default"])(TextureTransform,
...
targetTextureVarying:this.targetTextureVarying,targetTexture:targetTexture});Object.assign(uniforms,sourceTextures)}this.hasTargetTexture&&(opts=!1,parameters.viewport=[0,0,framebuffer.width,framebuffer.height]);return{attributes:_this$bindings$this$c,framebuffer:framebuffer,uniforms:uniforms,discard:opts,parameters:parameters}}},{key:"swap",value:function(){return this._swapTexture?(this.currentIndex=this._getNextIndex(),!0):!1}},{key:"update",value:function(){this._setupTextures(0<arguments.length&&
void 0!==arguments[0]?arguments[0]:{})}},{key:"getTargetTexture",value:function(){return this.bindings[this.currentIndex].targetTexture}},{key:"getData",value:function(){var _ref$packed=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).packed,packed=void 0===_ref$packed?!1:_ref$packed;_ref$packed=this.bindings[this.currentIndex].framebuffer;_ref$packed=(0,_webgl.readPixelsToArray)(_ref$packed);if(!packed)return _ref$packed;var ArrayType=_ref$packed.constructor;packed=(0,_shadertools.typeToChannelCount)(this.targetTextureType);
...
framebuffer?(framebuffer.update({attachments:(0,_defineProperty2["default"])({},36064,opts),resizeAttachments:!1}),framebuffer.resize({width:sourceBuffers,height:sourceTextures})):binding.framebuffer=new _webgl.Framebuffer(this.gl,{id:"".concat(this.id||"transform","-framebuffer"),width:sourceBuffers,height:sourceTextures,attachments:(0,_defineProperty2["default"])({},36064,opts)})}return binding}},{key:"_setSourceTextureParameters",value:function(){var sourceTextures=this.bindings[this.currentIndex].sourceTextures,
name;for(name in sourceTextures)sourceTextures[name].setParameters(SRC_TEX_PARAMETER_OVERRIDES)}},{key:"_swapTextures",value:function(opts){if(!this._swapTexture)return null;var sourceTextures=Object.assign({},opts.sourceTextures);sourceTextures[this._swapTexture]=opts.targetTexture;return{sourceTextures:sourceTextures,targetTexture:opts.sourceTextures[this._swapTexture]}}},{key:"_createNewTexture",value:function(refTexture){var _parameters;refTexture=(0,_webgl.cloneTextureFrom)(refTexture,{parameters:(_parameters=
...
props=this.hasSourceTextures||this.targetTextureVarying?[_shadertools._transform].concat(props.modules||[]):props.modules;return{vs:sourceTextures,fs:targetTextureType,modules:props,uniforms:_this$bindings$this$c2,inject:inject}}}]);return TextureTransform}();exports["default"]=require}
