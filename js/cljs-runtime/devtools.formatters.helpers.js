...
var G__93782 = devtools.prefs.pref(v);
v = G__93782;
continue;
} else {
return v;
...
}catch (e93720){var _e__79927__auto__ = e93720;
return false;
}})();
...
}catch (e93738){var _e__79927__auto__ = e93738;
return false;
}})();
...
}catch (e93746){var _e__79927__auto__ = e93746;
return false;
}}
}
});
...
var vec__93761 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93761,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93761,(1),null);
...
return cljs.core.some((function (p1__93767_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__93767_SHARP_);
}),template);
});
