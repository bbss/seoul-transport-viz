...
break}}conditionResult=void 0;try{conditionResult=resultSelector(state)}catch(err$344){subscriber.error(err$344);break}subscriber.next(conditionResult);if(subscriber.closed)break;try{state=iterate(state)}catch(err$345){subscriber.error(err$345);break}}while(1)})}}
