...
break}}conditionResult=void 0;try{conditionResult=resultSelector(state)}catch(err$347){subscriber.error(err$347);break}subscriber.next(conditionResult);if(subscriber.closed)break;try{state=iterate(state)}catch(err$348){subscriber.error(err$348);break}}while(1)})}}
