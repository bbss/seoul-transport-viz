...
null===b?Object.create(b):(__.prototype=b.prototype,new __)}}();Object.defineProperty(exports,"__esModule",{value:!0});exports.delayWhen=void 0;global=require("module$node_modules$rxjs$dist$cjs$internal$Subscriber");module=require("module$node_modules$rxjs$dist$cjs$internal$Observable");var OuterSubscriber_1=require("module$node_modules$rxjs$dist$cjs$internal$OuterSubscriber"),subscribeToResult_1=require("module$node_modules$rxjs$dist$cjs$internal$util$subscribeToResult");exports.delayWhen=function(delayDurationSelector,
subscriptionDelay){return subscriptionDelay?function(source){return(new SubscriptionDelayObservable(source,subscriptionDelay)).lift(new DelayWhenOperator(delayDurationSelector))}:function(source){return source.lift(new DelayWhenOperator(delayDurationSelector))}};var DelayWhenOperator=function(){function DelayWhenOperator(delayDurationSelector){this.delayDurationSelector=delayDurationSelector}DelayWhenOperator.prototype.call=function(subscriber,source){return source.subscribe(new DelayWhenSubscriber(subscriber,
...
innerSub){this.destination.next(outerValue);this.removeSubscription(innerSub);this.tryComplete()};DelayWhenSubscriber.prototype.notifyError=function(error,innerSub){this._error(error)};DelayWhenSubscriber.prototype.notifyComplete=function(innerSub){(innerSub=this.removeSubscription(innerSub))&&this.destination.next(innerSub);this.tryComplete()};DelayWhenSubscriber.prototype._next=function(value){var index=this.index++;try{var delayNotifier=this.delayDurationSelector(value,index);delayNotifier&&this.tryDelay(delayNotifier,
...
value){(delayNotifier=subscribeToResult_1.subscribeToResult(this,delayNotifier,value))&&!delayNotifier.closed&&(this.destination.add(delayNotifier),this.delayNotifierSubscriptions.push(delayNotifier))};DelayWhenSubscriber.prototype.tryComplete=function(){this.completed&&0===this.delayNotifierSubscriptions.length&&this.destination.complete()};return DelayWhenSubscriber}(OuterSubscriber_1.OuterSubscriber),SubscriptionDelayObservable=function(_super){function SubscriptionDelayObservable(source,subscriptionDelay){var _this=
