...
JSCompiler_object_inline_debug_6513=_globals.isBrowser?console.debug||console.log:console.log,JSCompiler_object_inline_log_6514=console.log,JSCompiler_object_inline_info_6515=console.info,JSCompiler_object_inline_warn_6516=console.warn,JSCompiler_object_inline_error_6517=console.error,DEFAULT_SETTINGS={enabled:!0,level:0},cache={},ONCE={once:!0};require=function(){function Log(){var id=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).id;(0,_classCallCheck2["default"])(this,Log);this.id=
...
{key:"getTotal",value:function(){return Number(((0,_hiResTimestamp["default"])()-this._startTs).toPrecision(10))}},{key:"getDelta",value:function(){return Number(((0,_hiResTimestamp["default"])()-this._deltaTs).toPrecision(10))}},{key:"getPriority",value:function(){return this.level}},{key:"enable",value:function(){this._storage.updateConfiguration({enabled:0<arguments.length&&void 0!==arguments[0]?arguments[0]:!0});return this}},{key:"setLevel",value:function(level){this._storage.updateConfiguration({level:level});
return this}},{key:"assert",value:function(condition,message){(0,_assert2["default"])(condition,message)}},{key:"warn",value:function(message){return this._getLogFunction(0,message,JSCompiler_object_inline_warn_6516,arguments,ONCE)}},{key:"error",value:function(message){return this._getLogFunction(0,message,JSCompiler_object_inline_error_6517,arguments)}},{key:"deprecated",value:function(oldUsage,newUsage){return this.warn("`".concat(oldUsage,"` is deprecated and will be removed in a later version. Use `").concat(newUsage,
"` instead"))}},{key:"removed",value:function(oldUsage,newUsage){return this.error("`".concat(oldUsage,"` has been removed. Use `").concat(newUsage,"` instead"))}},{key:"probe",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_log_6514,arguments,{time:!0,once:!0})}},{key:"log",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_debug_6513,arguments)}},{key:"info",value:function(logLevel,message){return this._getLogFunction(logLevel,
message,console.info,arguments)}},{key:"once",value:function(logLevel,message){return this._getLogFunction(logLevel,message,JSCompiler_object_inline_debug_6513||JSCompiler_object_inline_info_6515,arguments,ONCE)}},{key:"table",value:function(logLevel,_table,columns){return _table?this._getLogFunction(logLevel,_table,console.table||noop,columns&&[columns],{tag:getTableHeader(_table)}):noop}},{key:"image",value:function(_ref2){var priority=_ref2.priority,_image=_ref2.image,_ref2$message=_ref2.message;
...
noop)}},{key:"group",value:function(logLevel,message){var opts=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{collapsed:!1};opts=normalizeArguments({logLevel:logLevel,message:message,opts:opts});opts.method=(opts.collapsed?console.groupCollapsed:console.group)||console.info;return this._getLogFunction(opts)}},{key:"groupCollapsed",value:function(logLevel,message){return this.group(logLevel,message,Object.assign({},2<arguments.length&&void 0!==arguments[2]?arguments[2]:{},{collapsed:!0}))}},
{key:"groupEnd",value:function(logLevel){return this._getLogFunction(logLevel,"",console.groupEnd||noop)}},{key:"withGroup",value:function(logLevel,message,func){this.group(logLevel,message)();try{func()}finally{this.groupEnd(logLevel)()}}},{key:"trace",value:function(){console.trace&&console.trace()}},{key:"_shouldLog",value:function(logLevel){return this.isEnabled()&&this.getLevel()>=normalizeLogLevel(logLevel)}},{key:"_getLogFunction",value:function(logLevel,message$jscomp$0,method){var args=3<
arguments.length&&void 0!==arguments[3]?arguments[3]:[],opts=4<arguments.length?arguments[4]:void 0;if(this._shouldLog(logLevel)){var _method;opts=normalizeArguments({logLevel:logLevel,message:message$jscomp$0,args:args,opts:opts});method=method||opts.method;(0,_assert2["default"])(method);opts.total=this.getTotal();opts.delta=this.getDelta();this._deltaTs=(0,_hiResTimestamp["default"])();args=opts.tag||opts.message;if(opts.once){if(cache[args])return noop;cache[args]=(0,_hiResTimestamp["default"])()}args=
this.id;var message=opts.message,opts$jscomp$0=opts;if("string"===typeof message){var time=opts$jscomp$0.time?(0,_formatters.leftPad)((0,_formatters.formatTime)(opts$jscomp$0.total)):"";message=opts$jscomp$0.time?"".concat(args,": ").concat(time,"  ").concat(message):"".concat(args,": ").concat(message);message=(0,_color.addColor)(message,opts$jscomp$0.color,opts$jscomp$0.background)}return(_method=method).bind.apply(_method,[console,message].concat((0,_toConsumableArray2["default"])(opts.args)))}return noop}},
{key:"level",set:function(newLevel){this.setLevel(newLevel)},get:function(){return this.getLevel()}},{key:"priority",set:function(newPriority){this.level=newPriority},get:function(){return this.level}}]);return Log}();exports["default"]=require;require.VERSION=_globals.VERSION}
