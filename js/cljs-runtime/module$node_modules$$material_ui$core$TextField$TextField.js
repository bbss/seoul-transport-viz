...
_props$required;InputMore.label=React.createElement(React.Fragment,null,label,displayRequired&&" *")}_props$select&&(SelectProps&&SelectProps.native||(InputMore.id=void 0),InputMore["aria-describedby"]=void 0);_InputLabelProps$requ=helperText&&id?"".concat(id,"-helper-text"):void 0;displayRequired=label&&id?"".concat(id,"-label"):void 0;autoComplete=React.createElement(variantComponent[_props$variant],(0,_extends2.default)({"aria-describedby":_InputLabelProps$requ,autoComplete:autoComplete,autoFocus:autoFocus,
defaultValue:defaultValue,fullWidth:_props$fullWidth,multiline:_props$multiline,name:name,rows:rows,rowsMax:rowsMax,type:type,value:value,id:id,inputRef:inputRef,onBlur:onBlur,onChange:onChange,onFocus:onFocus,placeholder:placeholder,inputProps:inputProps},InputMore,InputProps));return React.createElement(_FormControl.default,(0,_extends2.default)({className:(0,_clsx.default)(classes.root,className),disabled:_props$disabled,error:_props$error,fullWidth:_props$fullWidth,hiddenLabel:hiddenLabel,ref:ref,
required:_props$required,color:_props$color,variant:_props$variant},props),label&&React.createElement(_InputLabel.default,(0,_extends2.default)({htmlFor:id,id:displayRequired},InputLabelProps),label),_props$select?React.createElement(_Select.default,(0,_extends2.default)({"aria-describedby":_InputLabelProps$requ,id:id,labelId:displayRequired,value:value,input:autoComplete},SelectProps),_props$autoFocus):autoComplete,helperText&&React.createElement(_FormHelperText.default,(0,_extends2.default)({id:_InputLabelProps$requ},
FormHelperTextProps),helperText))});_Input.propTypes={autoComplete:global.default.string,autoFocus:global.default.bool,children:global.default.node,classes:global.default.object,className:global.default.string,color:global.default.oneOf(["primary","secondary"]),defaultValue:global.default.any,disabled:global.default.bool,error:global.default.bool,FormHelperTextProps:global.default.object,fullWidth:global.default.bool,helperText:global.default.node,hiddenLabel:global.default.bool,id:global.default.string,
InputLabelProps:global.default.object,inputProps:global.default.object,InputProps:global.default.object,inputRef:module.refType,label:global.default.node,margin:global.default.oneOf(["dense","none","normal"]),multiline:global.default.bool,name:global.default.string,onBlur:global.default.func,onChange:global.default.func,onFocus:global.default.func,placeholder:global.default.string,required:global.default.bool,rows:global.default.oneOfType([global.default.number,global.default.string]),rowsMax:global.default.oneOfType([global.default.number,
