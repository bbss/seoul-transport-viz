...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__67344){
var vec__67346 = p__67344;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67346,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67346,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__67354_SHARP_){
return (((p1__67354_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__67354_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__67356,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__67356;
}
});
...
var len__4736__auto___67386 = arguments.length;
var i__4737__auto___67388 = (0);
while(true){
if((i__4737__auto___67388 < len__4736__auto___67386)){
args__4742__auto__.push((arguments[i__4737__auto___67388]));

var G__67390 = (i__4737__auto___67388 + (1));
i__4737__auto___67388 = G__67390;
continue;
} else {
}
break;
...
var G__67359 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67359,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__67359;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq67358){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67358));
}));
...
var vec__67364 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__67368 = cljs.core.ffirst(matches);
var fexpr__67367 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__67367.cljs$core$IFn$_invoke$arity$1 ? fexpr__67367.cljs$core$IFn$_invoke$arity$1(G__67368) : fexpr__67367.call(null,G__67368));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67364,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67364,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__67361_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__67361_SHARP_))){
return p1__67361_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__67362_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__67362_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__67373){
var vec__67375 = p__67373;
...
var tag = first__67377;
var content = seq__67376__$1;
...
var vec__67379 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67379,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67379,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67379,(2),null);
