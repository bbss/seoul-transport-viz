...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__93995){
var vec__93996 = p__93995;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93996,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__93996,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__94001_SHARP_){
return (((p1__94001_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__94001_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__94004,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__94004;
}
});
...
var len__4736__auto___94068 = arguments.length;
var i__4737__auto___94070 = (0);
while(true){
if((i__4737__auto___94070 < len__4736__auto___94068)){
args__4742__auto__.push((arguments[i__4737__auto___94070]));

var G__94073 = (i__4737__auto___94070 + (1));
i__4737__auto___94070 = G__94073;
continue;
} else {
}
break;
...
var G__94010 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__94010,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__94010;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq94005){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq94005));
}));
...
var vec__94018 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__94023 = cljs.core.ffirst(matches);
var fexpr__94022 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__94022.cljs$core$IFn$_invoke$arity$1 ? fexpr__94022.cljs$core$IFn$_invoke$arity$1(G__94023) : fexpr__94022.call(null,G__94023));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94018,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94018,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__94014_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__94014_SHARP_))){
return p1__94014_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__94017_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__94017_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__94031){
var vec__94033 = p__94031;
var seq__94034 = cljs.core.seq(vec__94033);
var first__94035 = cljs.core.first(seq__94034);
var seq__94034__$1 = cljs.core.next(seq__94034);
var tag = first__94035;
var content = seq__94034__$1;
...
var vec__94039 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94039,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94039,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__94039,(2),null);
