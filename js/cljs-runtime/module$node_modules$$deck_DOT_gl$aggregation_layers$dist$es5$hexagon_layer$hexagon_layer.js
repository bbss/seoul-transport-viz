...
arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key])}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}return target}function nop(){}var _interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");
Object.defineProperty(exports,"__esModule",{value:!0});exports["default"]=void 0;var _defineProperty2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$defineProperty")),_classCallCheck2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$classCallCheck")),_createClass2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$createClass")),_possibleConstructorReturn2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$possibleConstructorReturn")),
_getPrototypeOf2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$getPrototypeOf")),_get2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$get")),_inherits2=_interopRequireDefault(require("module$node_modules$$babel$runtime$helpers$inherits")),_core=require("module$node_modules$$deck_DOT_gl$core$dist$es5$index"),_layers=require("module$node_modules$$deck_DOT_gl$layers$dist$es5$index");global=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$color_utils");
module=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$hexagon_layer$hexagon_aggregator");var _cpuAggregator=_interopRequireDefault(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$cpu_aggregator"));require=_interopRequireDefault(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$aggregation_layer"));global={colorDomain:null,colorRange:global.defaultColorRange,getColorValue:{type:"accessor",value:null},getColorWeight:{type:"accessor",
value:function(x){return 1}},colorAggregation:"SUM",lowerPercentile:{type:"number",value:0,min:0,max:100},upperPercentile:{type:"number",value:100,min:0,max:100},colorScaleType:"quantize",onSetColorDomain:nop,elevationDomain:null,elevationRange:[0,1E3],getElevationValue:{type:"accessor",value:null},getElevationWeight:{type:"accessor",value:function(x){return 1}},elevationAggregation:"SUM",elevationLowerPercentile:{type:"number",value:0,min:0,max:100},elevationUpperPercentile:{type:"number",value:100,
min:0,max:100},elevationScale:{type:"number",min:0,value:1},elevationScaleType:"linear",onSetElevationDomain:nop,radius:{type:"number",value:1E3,min:1},coverage:{type:"number",min:0,max:1,value:1},extruded:!1,hexagonAggregator:module.pointToHexbin,getPosition:{type:"accessor",value:function(x){return x.position}},material:!0,_filterData:{type:"function",value:null,optional:!0}};require=function(_AggregationLayer){function HexagonLayer(){(0,_classCallCheck2["default"])(this,HexagonLayer);return(0,
_possibleConstructorReturn2["default"])(this,(0,_getPrototypeOf2["default"])(HexagonLayer).apply(this,arguments))}(0,_inherits2["default"])(HexagonLayer,_AggregationLayer);(0,_createClass2["default"])(HexagonLayer,[{key:"shouldUpdateState",value:function(_ref){return _ref.changeFlags.somethingChanged}},{key:"initializeState",value:function(){var cpuAggregator=new _cpuAggregator["default"]({getAggregator:function(props){return props.hexagonAggregator},getCellSize:function(props){return props.radius}});
this.state={cpuAggregator:cpuAggregator,aggregatorState:cpuAggregator.state,hexagonVertices:null};this.getAttributeManager().add({positions:{size:3,accessor:"getPosition"}})}},{key:"updateState",value:function(opts){(0,_get2["default"])((0,_getPrototypeOf2["default"])(HexagonLayer.prototype),"updateState",this).call(this,opts);var _this$state=this.state,cpuAggregator=_this$state.cpuAggregator;_this$state=_this$state.hexagonVertices;opts.changeFlags.propsOrDataChanged&&this.setState({aggregatorState:cpuAggregator.updateState(opts,
...
var SubLayerClass=this.getSubLayerClass("hexagon-cell",_layers.ColumnLayer),updateTriggers=this._getSublayerUpdateTriggers();return new SubLayerClass(_objectSpread({},_this$state2&&_this$state2.length?{vertices:_this$state2,radius:1}:{radius:radius,angle:angle},{diskResolution:6,elevationScale:elevationScale,extruded:extruded,coverage:coverage,material:material,getFillColor:this._onGetSublayerColor.bind(this),getElevation:this._onGetSublayerElevation.bind(this),transitions:_this$props&&{getFillColor:_this$props.getColorValue||
_this$props.getColorWeight,getElevation:_this$props.getElevationValue||_this$props.getElevationWeight}}),this.getSubLayerProps({id:"hexagon-cell",updateTriggers:updateTriggers}),{data:cpuAggregator.state.layerData.data})}}]);return HexagonLayer}(require["default"]);exports["default"]=require;require.layerName="HexagonLayer";require.defaultProps=global}
