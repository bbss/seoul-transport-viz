...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_96527 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_96527(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_96561 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_96561(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_96577 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_96577(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_96592 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_96592(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_96605 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_96605(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_96622 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_96622(reader);
}
});
...
var G__96780 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__96781 = s.append(c);
c = G__96780;
s = G__96781;
continue;
}
