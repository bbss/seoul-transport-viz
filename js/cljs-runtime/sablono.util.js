...
var sablono$util$ToString$to_str$dyn_67339 = (function (x){
...
return sablono$util$ToString$to_str$dyn_67339(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_67340 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_67340(x);
}
});
...
var G__67345 = (i__4737__auto___67343 + (1));
i__4737__auto___67343 = G__67345;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq67314){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67314));
}));
...
var vec__67317 = cljs.core.name(k).split("-");
var seq__67318 = cljs.core.seq(vec__67317);
var first__67319 = cljs.core.first(seq__67318);
var seq__67318__$1 = cljs.core.next(seq__67318);
var first_word = first__67319;
var words = seq__67318__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__67322){
var vec__67324 = p__67322;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67324,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67324,(1),null);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__67327,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__67327;
}
} else {
