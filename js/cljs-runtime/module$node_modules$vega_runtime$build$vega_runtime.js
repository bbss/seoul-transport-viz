...
op);if(spec.data){data={};for(var name in spec.data)data.$jscomp$loop$prop$data$659$695=ctx.data[name]||(ctx.data[name]={}),spec.data[name].forEach(function($jscomp$loop$694){return function(role){return $jscomp$loop$694.$jscomp$loop$prop$data$659$695[role]=op}}(data)),data={$jscomp$loop$prop$data$659$695:data.$jscomp$loop$prop$data$659$695}}},resolve:function(){(this.unresolved||[]).forEach(function(fn){return fn()});delete this.unresolved;return this},operator:function(spec,update){this.add(spec,
