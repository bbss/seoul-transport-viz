shadow$provide.module$node_modules$react_map_gl$dist$es5$utils$transition_manager=function(global,require,module,exports){function cropEasingFunction(easing,x0){var y0=easing(x0);return function(t){return 1/(1-y0)*(easing(t*(1-x0)+x0)-y0)}}module=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.cropEasingFunction=cropEasingFunction;exports["default"]=exports.TRANSITION_EVENTS=void 0;var _classCallCheck2=module(require("module$node_modules$$babel$runtime$helpers$classCallCheck")),
_createClass2=module(require("module$node_modules$$babel$runtime$helpers$createClass")),_defineProperty2=module(require("module$node_modules$$babel$runtime$helpers$defineProperty")),_assert=module(require("module$node_modules$react_map_gl$dist$es5$utils$assert"));global=require("module$node_modules$react_map_gl$dist$es5$utils$transition$index");var _mapState=module(require("module$node_modules$react_map_gl$dist$es5$utils$map_state"));require=function(){};var TRANSITION_EVENTS={BREAK:1,SNAP_TO_END:2,
IGNORE:3,UPDATE:4};exports.TRANSITION_EVENTS=TRANSITION_EVENTS;require={transitionDuration:0,transitionEasing:function(t){return t},transitionInterpolator:new global.LinearInterpolator,transitionInterruption:TRANSITION_EVENTS.BREAK,onTransitionStart:require,onTransitionInterrupt:require,onTransitionEnd:require,onViewportChange:require,onStateChange:require};global=function(){function TransitionManager(props,getTime){var _this=this;(0,_classCallCheck2["default"])(this,TransitionManager);(0,_defineProperty2["default"])(this,
"props",void 0);(0,_defineProperty2["default"])(this,"state",void 0);(0,_defineProperty2["default"])(this,"time",void 0);(0,_defineProperty2["default"])(this,"_animationFrame",null);(0,_defineProperty2["default"])(this,"_onTransitionFrame",function(){_this._animationFrame=requestAnimationFrame(_this._onTransitionFrame);_this._updateViewport()});props&&(this.props=props);this.time=getTime||Date.now}(0,_createClass2["default"])(TransitionManager,[{key:"getViewportInTransition",value:function(){return this._animationFrame?
this.state.propsInTransition:null}},{key:"processViewportChange",value:function(nextProps){var currentProps=this.props;this.props=nextProps;if(this._shouldIgnoreViewportChange(currentProps,nextProps))return!1;if(this._isTransitionEnabled(nextProps)){var startProps=Object.assign({},currentProps);nextProps=Object.assign({},nextProps);if(this._isTransitionInProgress()&&(currentProps.onTransitionInterrupt(),this.state.interruption===TRANSITION_EVENTS.SNAP_TO_END?Object.assign(startProps,this.state.endProps):
...
endProps.bearing||startProps.pitch!==endProps.pitch};this.state={duration:transitionInterpolator,easing:endProps.transitionEasing,interpolator:endProps.transitionInterpolator,interruption:endProps.transitionInterruption,startTime:this.time(),startProps:initialProps.start,endProps:initialProps.end,animation:null,propsInTransition:{},interactionState:startProps};this._onTransitionFrame();this.props.onStateChange(startProps)}}},{key:"_endTransition",value:function(){this._animationFrame&&(cancelAnimationFrame(this._animationFrame),
this._animationFrame=null);this.props.onStateChange({inTransition:!1,isZooming:!1,isPanning:!1,isRotating:!1})}},{key:"_updateViewport",value:function(){var currentTime=this.time(),_this$state=this.state,easing=_this$state.easing,interpolator=_this$state.interpolator,startProps=_this$state.startProps,endProps=_this$state.endProps,shouldEnd=!1;currentTime=(currentTime-_this$state.startTime)/_this$state.duration;1<=currentTime&&(currentTime=1,shouldEnd=!0);currentTime=easing(currentTime);easing=interpolator.interpolateProps(startProps,
endProps,currentTime);easing=new _mapState["default"](Object.assign({},this.props,easing));this.state.propsInTransition=easing.getViewportProps();this.props.onViewportChange(this.state.propsInTransition,this.state.interactionState,this.props);shouldEnd&&(this._endTransition(),this.props.onTransitionEnd())}}]);return TransitionManager}();exports["default"]=global;(0,_defineProperty2["default"])(global,"defaultProps",require)}
