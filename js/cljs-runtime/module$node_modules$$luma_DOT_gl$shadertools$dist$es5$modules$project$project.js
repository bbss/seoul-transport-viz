...
require="\n".concat("varying vec4 project_vPositionWorld;\nvarying vec3 project_vNormalWorld;\n\nvec4 project_getPosition_World() {\n  return project_vPositionWorld;\n}\n\nvec3 project_getNormal_World() {\n  return project_vNormalWorld;\n}\n");exports["default"]={name:"project",getUniforms:function(){var opts=0<arguments.length&&void 0!==arguments[0]?arguments[0]:DEFAULT_MODULE_OPTIONS,uniforms={};void 0!==opts.modelMatrix&&(uniforms.modelMatrix=opts.modelMatrix);void 0!==opts.viewMatrix&&(uniforms.viewMatrix=
