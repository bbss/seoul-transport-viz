...
}}_iteratorNormalCompletion=!0;_didIteratorError=!1;_iteratorError=void 0;try{for(var _iterator2=this._internalEffects[Symbol.iterator](),_step2;!(_iteratorNormalCompletion=(_step2=_iterator2.next()).done);_iteratorNormalCompletion=!0)_step2.value.cleanup()}catch(err$393){_didIteratorError=!0,_iteratorError=err$393}finally{try{if(!_iteratorNormalCompletion&&null!=_iterator2["return"])_iterator2["return"]()}finally{if(_didIteratorError)throw _iteratorError;}}this.effects.length=0;this._internalEffects.length=
