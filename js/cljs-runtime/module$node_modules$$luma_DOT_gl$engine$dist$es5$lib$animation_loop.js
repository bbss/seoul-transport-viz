...
this.props.onAddHTML(div))div.innerHTML=wrapperDiv}}},{key:"_getSizeAndAspect",value:function(){var width=this.gl.drawingBufferWidth,height=this.gl.drawingBufferHeight,aspect=1,canvas=this.gl.canvas;canvas&&canvas.clientHeight?aspect=canvas.clientWidth/canvas.clientHeight:0<width&&0<height&&(aspect=width/height);return{width:width,height:height,aspect:aspect}}},{key:"_resizeViewport",value:function(){this.autoResizeViewport&&this.gl.viewport(0,0,this.gl.drawingBufferWidth,this.gl.drawingBufferHeight)}},
{key:"_resizeCanvasDrawingBuffer",value:function(){this.autoResizeDrawingBuffer&&(0,_gltools.resizeGLContext)(this.gl,{useDevicePixels:this.useDevicePixels})}},{key:"_createFramebuffer",value:function(){this.props.createFramebuffer&&(this.framebuffer=new _webgl.Framebuffer(this.gl))}},{key:"_resizeFramebuffer",value:function(){this.framebuffer&&this.framebuffer.resize({width:this.gl.drawingBufferWidth,height:this.gl.drawingBufferHeight})}},{key:"_beginTimers",value:function(){this.frameRate.timeEnd();
this.frameRate.timeStart();this._gpuTimeQuery&&this._gpuTimeQuery.isResultAvailable()&&!this._gpuTimeQuery.isTimerDisjoint()&&this.stats.get("GPU Time").addTime(this._gpuTimeQuery.getTimerMilliseconds());this._gpuTimeQuery&&this._gpuTimeQuery.beginTimeElapsedQuery();this.cpuTime.timeStart()}},{key:"_endTimers",value:function(){this.cpuTime.timeEnd();this._gpuTimeQuery&&this._gpuTimeQuery.end()}},{key:"_startEventHandling",value:function(){var canvas=this.gl.canvas;canvas&&(canvas.addEventListener("mousemove",
this._onMousemove),canvas.addEventListener("mouseleave",this._onMouseleave))}},{key:"_onMousemove",value:function(e){this.animationProps._mousePosition=[e.offsetX,e.offsetY]}},{key:"_onMouseleave",value:function(e){this.animationProps._mousePosition=null}}]);return AnimationLoop}();exports["default"]=require}
