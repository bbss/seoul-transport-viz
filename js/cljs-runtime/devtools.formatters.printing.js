...
var len__4736__auto___93867 = arguments.length;
var i__4737__auto___93868 = (0);
while(true){
if((i__4737__auto___93868 < len__4736__auto___93867)){
args__4742__auto__.push((arguments[i__4737__auto___93868]));

var G__93871 = (i__4737__auto___93868 + (1));
i__4737__auto___93868 = G__93871;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq93792){
var G__93793 = cljs.core.first(seq93792);
var seq93792__$1 = cljs.core.next(seq93792);
var G__93794 = cljs.core.first(seq93792__$1);
var seq93792__$2 = cljs.core.next(seq93792__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__93793,G__93794,seq93792__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__93809_SHARP_){
return (!((cljs.core.meta(p1__93809_SHARP_) == null)));
})))){
...
var map__93824 = opts;
var map__93824__$1 = (((((!((map__93824 == null))))?(((((map__93824.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__93824.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__93824):map__93824);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93824__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e93835){var _e__79927__auto__ = e93835;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e93839){var _e__79927__auto__ = e93839;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__93849 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__93850 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__93850);

try{var map__93851 = opts;
var map__93851__$1 = (((((!((map__93851 == null))))?(((((map__93851.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__93851.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__93851):map__93851);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__93851__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__93849);
}});
...
var temp__5733__auto___93893 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___93893)){
var managed_print_level_93894 = temp__5733__auto___93893;
var _STAR_print_level_STAR__orig_val__93858_93895 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__93859_93896 = managed_print_level_93894;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__93859_93896);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__93855_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__93855_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__93858_93895);
}} else {
job_fn();
}
