...
var len__4736__auto___67223 = arguments.length;
var i__4737__auto___67224 = (0);
while(true){
if((i__4737__auto___67224 < len__4736__auto___67223)){
args__4742__auto__.push((arguments[i__4737__auto___67224]));

var G__67225 = (i__4737__auto___67224 + (1));
i__4737__auto___67224 = G__67225;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq67102){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67103,G__67104,seq67102__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__67134_SHARP_){
return (!((cljs.core.meta(p1__67134_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67147__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e67157){var _e__66106__auto__ = e67157;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e67161){var _e__66106__auto__ = e67161;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__67183 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__67184 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__67184);

try{var map__67185 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67185__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__67183);
}});
...
var temp__5733__auto___67248 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___67248)){
var managed_print_level_67250 = temp__5733__auto___67248;
var _STAR_print_level_STAR__orig_val__67211_67251 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__67212_67252 = managed_print_level_67250;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__67212_67252);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__67203_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__67203_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__67211_67251);
}} else {
job_fn();
}
