...
resourceId.startsWith(protocol)&&(resourceId=resourceId.replace(protocol,""),resources[resourceId]||this.add({resourceId:resourceId,data:null,persistent:!1}));resourceId=resources[resourceId];this._track(consumerId,_ref4,resourceId,onChange);if(resourceId)return resourceId.getData()}},{key:"prune",value:function(){var _this=this;this._pruneRequest||(this._pruneRequest=setTimeout(function(){return _this._prune()},0))}},{key:"finalize",value:function(){for(var key in this._resources)this._resources[key]["delete"]()}},
