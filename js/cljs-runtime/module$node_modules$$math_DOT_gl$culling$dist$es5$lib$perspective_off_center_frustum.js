...
null!=arguments[i]?arguments[i]:{};i%2?ownKeys(source,!0).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key])}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}return target}function update(frustum){(0,_core.assert)(Number.isFinite(frustum.right)&&Number.isFinite(frustum.left)&&Number.isFinite(frustum.top)&&
...
top,frustum._bottom=bottom,frustum._near=near,frustum._far=far,frustum._perspectiveMatrix=(new _core.Matrix4).frustum({left:left,right:right,bottom:bottom,top:top,near:near,far:far}),frustum._infinitePerspective=(new _core.Matrix4).frustum({left:left,right:right,bottom:bottom,top:top,near:near,far:Infinity})}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports["default"]=void 0;var _defineProperty2=global(require("module$node_modules$$babel$runtime$helpers$defineProperty")),
