...
void 0!==arguments[2]?arguments[2]:{})),location=_this$_resolveLocatio2.location;_this$_resolveLocatio2=_this$_resolveLocatio2.accessor;0<=location&&(arrayValue=this.vertexArrayObject._normalizeConstantArrayValue(arrayValue,_this$_resolveLocatio2),this.values[location]=arrayValue,this.accessors[location]=_this$_resolveLocatio2,this.clearDrawParams(),this.vertexArrayObject.enable(location,!1));return this}},{key:"unbindBuffers",value:function(){var _this2=this;this.vertexArrayObject.bind(function(){_this2.elements&&
_this2.vertexArrayObject.setElementBuffer(null);_this2.buffer=_this2.buffer||new _buffer["default"](_this2.gl,{accessor:{size:4}});for(var location=0;location<_this2.vertexArrayObject.MAX_ATTRIBUTES;location++)_this2.values[location]instanceof _buffer["default"]&&(_this2.gl.disableVertexAttribArray(location),_this2.gl.bindBuffer(34962,_this2.buffer.handle),_this2.gl.vertexAttribPointer(location,1,5126,!1,0,0))});return this}},{key:"bindBuffers",value:function(){var _this3=this;this.vertexArrayObject.bind(function(){_this3.elements&&
_this3.setElementBuffer(_this3.elements);for(var location=0;location<_this3.vertexArrayObject.MAX_ATTRIBUTES;location++){var buffer=_this3.values[location];buffer instanceof _buffer["default"]&&_this3.setBuffer(location,buffer)}});return this}},{key:"bindForDraw",value:function(vertexCount,instanceCount,func){var _this4=this,value;this.vertexArrayObject.bind(function(){_this4._setConstantAttributes(vertexCount,instanceCount);value=func()});return value}},{key:"_resolveLocationAndAccessor",value:function(locationOrName,
value,valueAccessor,appAccessor){var _this5=this,_this$_getAttributeIn=this._getAttributeIndex(locationOrName),location=_this$_getAttributeIn.location;_this$_getAttributeIn=_this$_getAttributeIn.name;if(!Number.isFinite(location)||0>location)return this.unused[locationOrName]=value,_gltools.log.once(3,function(){return"unused value ".concat(locationOrName," in ").concat(_this5.id)})(),this;value=this._getAttributeInfo(_this$_getAttributeIn||location);if(!value)return{location:-1,accessor:null};valueAccessor=
_accessor2["default"].resolve(value.accessor,this.accessors[location]||{},valueAccessor,appAccessor);appAccessor=valueAccessor.size;value=valueAccessor.type;(0,_utils.assert)(Number.isFinite(appAccessor)&&Number.isFinite(value));return{location:location,accessor:valueAccessor}}},{key:"_getAttributeInfo",value:function(attributeName){return this.configuration&&this.configuration.getAttributeInfo(attributeName)}},{key:"_getAttributeIndex",value:function(locationOrName){var location=Number(locationOrName);
if(Number.isFinite(location))return{location:location};locationOrName=(location=MULTI_LOCATION_ATTRIBUTE_REGEXP.exec(locationOrName))?location[1]:locationOrName;location=location?Number(location[2]):0;return this.configuration?{location:this.configuration.getAttributeLocation(locationOrName)+location,name:locationOrName}:{location:-1}}},{key:"_setAttribute",value:function(locationOrName,value){if(value instanceof _buffer["default"])this.setBuffer(locationOrName,value);else if(Array.isArray(value)&&
