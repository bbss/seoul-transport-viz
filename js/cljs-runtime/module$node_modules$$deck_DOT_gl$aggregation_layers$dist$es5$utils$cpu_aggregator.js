...
props,changeFlags){for(var key in this.dimensionUpdaters){var _this$dimensionUpdate=this.dimensionUpdaters[key].getBins.triggers,weight=_this$dimensionUpdate.weight,aggregation=_this$dimensionUpdate.aggregation;_this$dimensionUpdate=props[_this$dimensionUpdate.value.prop];this.needUpdateDimensionStep(this.dimensionUpdaters[key].getBins,oldProps,props,changeFlags)&&null===_this$dimensionUpdate&&(_this$dimensionUpdate=(0,_aggregationOperationUtils.getValueFunc)(props[aggregation.prop],props[weight.prop]));
_this$dimensionUpdate&&this.setDimensionState(key,{getValue:_this$dimensionUpdate})}}},{key:"needsReProjectPoints",value:function(oldProps,props,changeFlags){return this._getCellSize(oldProps)!==this._getCellSize(props)||this._getAggregator(oldProps)!==this._getAggregator(props)||changeFlags.updateTriggersChanged&&(changeFlags.updateTriggersChanged.all||changeFlags.updateTriggersChanged.getPosition)}},{key:"addDimension",value:function(dimensions){this._addDimension(dimensions)}},{key:"_addDimension",
value:function(){var _this=this;(0<arguments.length&&void 0!==arguments[0]?arguments[0]:[]).forEach(function(dimension){var key=dimension.key;_this.dimensionUpdaters[key]=_this.getDimensionUpdaters(dimension);_this.state.dimensions[key]={getValue:null,domain:null,sortedBins:null,scaleFunc:nop}})}},{key:"getDimensionUpdaters",value:function(_ref){var key=_ref.key,getDomain=_ref.getDomain,getScaleFunc=_ref.getScaleFunc,nullValue=_ref.nullValue;return{key:key,accessor:_ref.accessor,pickingInfo:_ref.pickingInfo,
getBins:Object.assign({updater:this.getDimensionSortedBins},_ref.getBins),getDomain:Object.assign({updater:this.getDimensionValueDomain},getDomain),getScaleFunc:Object.assign({updater:this.getDimensionScale},getScaleFunc),attributeAccessor:this.getSubLayerDimensionAttribute(key,nullValue)}}},{key:"needUpdateDimensionStep",value:function(dimensionStep,oldProps,props,changeFlags){return Object.values(dimensionStep.triggers).some(function(item){return item.updateTrigger?changeFlags.updateTriggersChanged&&
(changeFlags.updateTriggersChanged.all||changeFlags.updateTriggersChanged[item.updateTrigger]):oldProps[item.prop]!==props[item.prop]})}},{key:"getDimensionChanges",value:function(oldProps,props,changeFlags){var _this2=this,updaters=[],_loop=function(key){var needUpdate=dimensionSteps.find(function(step){return _this2.needUpdateDimensionStep(_this2.dimensionUpdaters[key][step],oldProps,props,changeFlags)});needUpdate&&updaters.push(_this2.dimensionUpdaters[key][needUpdate].updater.bind(_this2,props,
_this2.dimensionUpdaters[key]))},key$jscomp$0;for(key$jscomp$0 in this.dimensionUpdaters)_loop(key$jscomp$0);return updaters.length?updaters:null}},{key:"getUpdateTriggers",value:function(props){var _this3=this,_updateTriggers=props.updateTriggers||{},updateTriggers={},_loop2=function(key){var accessor=_this3.dimensionUpdaters[key].accessor;updateTriggers[accessor]={};dimensionSteps.forEach(function(step){Object.values(_this3.dimensionUpdaters[key][step].triggers).forEach(function(_ref2){var prop=
...
{key:"getDimensionSortedBins",value:function(props,dimensionUpdater){var key=dimensionUpdater.key,sortedBins=new _binSorter["default"](this.state.layerData.data||[],{getValue:this.state.dimensions[key].getValue,filterData:props._filterData});this.setDimensionState(key,{sortedBins:sortedBins});this.getDimensionValueDomain(props,dimensionUpdater)}},{key:"getDimensionValueDomain",value:function(props,dimensionUpdater){var key=dimensionUpdater.key,_getDomain$triggers=dimensionUpdater.getDomain.triggers;
_getDomain$triggers=this.state.dimensions[key].sortedBins.getValueDomainByScale(props[_getDomain$triggers.scaleType.prop],[props[_getDomain$triggers.lowerPercentile.prop],props[_getDomain$triggers.upperPercentile.prop]]);this.setDimensionState(key,{valueDomain:_getDomain$triggers});this.getDimensionScale(props,dimensionUpdater)}},{key:"getDimensionScale",value:function(props,dimensionUpdater){var key=dimensionUpdater.key,getScaleFunc=dimensionUpdater.getScaleFunc,_getScaleFunc$trigger=getScaleFunc.triggers;
dimensionUpdater=dimensionUpdater.getDomain.triggers.scaleType;getScaleFunc=getScaleFunc.onSet;var dimensionRange=props[_getScaleFunc$trigger.range.prop];_getScaleFunc$trigger=props[_getScaleFunc$trigger.domain.prop]||this.state.dimensions[key].valueDomain;_getScaleFunc$trigger=(0,_scaleUtils.getScaleFunctionByScaleType)(dimensionUpdater&&props[dimensionUpdater.prop])(_getScaleFunc$trigger,dimensionRange);if("object"===(0,_typeof2["default"])(getScaleFunc)&&"function"===typeof props[getScaleFunc.props])props[getScaleFunc.props](_getScaleFunc$trigger.domain());
...
binInfo[this.dimensionUpdaters[key].pickingInfo]=sortedBins.binMap[object.index]&&sortedBins.binMap[object.index].value}object=Object.assign(binInfo,object,{points:object.filteredPoints||object.points})}return Object.assign(_ref3,{picked:!!object,object:object})}},{key:"getAccessor",value:function(dimensionKey){return this.dimensionUpdaters.hasOwnProperty(dimensionKey)?this.dimensionUpdaters[dimensionKey].attributeAccessor:nop}}],[{key:"defaultDimensions",value:function(){return _defaultDimensions}}]);
return CPUAggregator}();exports["default"]=require}
