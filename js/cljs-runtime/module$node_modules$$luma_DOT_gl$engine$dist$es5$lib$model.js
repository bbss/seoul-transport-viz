...
Model);var _props$id=props.id;_props$id=void 0===_props$id?(0,_webgl.uid)("model"):_props$id;(0,_webgl.assert)((0,_gltools.isWebGL)(gl));this.id=_props$id;this.gl=gl;this.id=props.id||(0,_webgl.uid)("Model");this.lastLogTime=0;this.initialize(props)}(0,_createClass2["default"])(Model,[{key:"initialize",value:function(props){this.props={};this.programManager=props.programManager||_programManager["default"].getDefaultProgramManager(this.gl);this._programManagerState=-1;this._managedProgram=!1;var _props$program=
props.program;this.programProps={program:void 0===_props$program?null:_props$program,vs:props.vs,fs:props.fs,modules:props.modules,defines:props.defines,inject:props.inject,varyings:props.varyings,bufferMode:props.bufferMode,transpileToGLSL100:props.transpileToGLSL100};this.vertexArray=this.program=null;this._programDirty=!0;this.userData={};this.needsRedraw=!0;this._attributes={};this.attributes={};this.uniforms={};this.pickable=!0;this._checkProgram();this.setUniforms(Object.assign({},this.getModuleUniforms(props.moduleSettings)));
this.drawMode=void 0!==props.drawMode?props.drawMode:4;this.vertexCount=props.vertexCount||0;this.geometryBuffers={};this.isInstanced=props.isInstanced||props.instanced||0<props.instanceCount;this._setModelProps(props);this.geometry={};(0,_webgl.assert)(void 0!==this.drawMode&&Number.isFinite(this.vertexCount),"Model needs drawMode and vertexCount")}},{key:"setProps",value:function(props){this._setModelProps(props)}},{key:"delete",value:function(){for(var key in this._attributes)if(this._attributes[key]!==
...
new _webgl.VertexArray(this.gl,{program:this.program}),this.setUniforms(Object.assign({},this.getModuleUniforms())))}}},{key:"_deleteGeometryBuffers",value:function(){for(var name in this.geometryBuffers){var buffer=this.geometryBuffers[name][0]||this.geometryBuffers[name];if(buffer instanceof _webgl.Buffer)buffer["delete"]()}}},{key:"_setAnimationProps",value:function(animationProps){this.animated&&((0,_webgl.assert)(animationProps,"Model.draw(): animated uniforms but no animationProps"),animationProps=
this._evaluateAnimateUniforms(animationProps),Object.assign(this.uniforms,animationProps))}},{key:"_setFeedbackBuffers",value:function(){var feedbackBuffers=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if((0,_webgl.isObjectEmpty)(feedbackBuffers))return this;var gl=this.program.gl;this.transformFeedback=this.transformFeedback||new _webgl.TransformFeedback(gl,{program:this.program});this.transformFeedback.setBuffers(feedbackBuffers);return this}},{key:"_logDrawCallStart",value:function(logLevel){var logDrawTimeout=
3<logLevel?0:1E4;if(!(Date.now()-this.lastLogTime<logDrawTimeout))return this.lastLogTime=Date.now(),_webgl.log.group(2,"\x3e\x3e\x3e DRAWING MODEL ".concat(this.id),{collapsed:2>=_webgl.log.level})(),logLevel}},{key:"_logDrawCallEnd",value:function(logLevel,vertexArray,uniforms,framebuffer){if(void 0!==logLevel){vertexArray=(0,_webgl.getDebugTableForVertexArray)({vertexArray:vertexArray,header:"".concat(this.id," attributes"),attributes:this._attributes});var _getDebugTableForUnif=(0,_webgl.getDebugTableForUniforms)({header:"".concat(this.id,
" uniforms"),program:this.program,uniforms:Object.assign({},this.program.uniforms,uniforms)}),uniformTable=_getDebugTableForUnif.table,unusedTable=_getDebugTableForUnif.unusedTable;_getDebugTableForUnif=_getDebugTableForUnif.unusedCount;uniforms=(0,_webgl.getDebugTableForUniforms)({header:"".concat(this.id," uniforms"),program:this.program,uniforms:Object.assign({},this.program.uniforms,uniforms),undefinedOnly:!0});var missingTable=uniforms.table;0<uniforms.count&&_webgl.log.log("MISSING UNIFORMS",
Object.keys(missingTable))();0<_getDebugTableForUnif&&_webgl.log.log("UNUSED UNIFORMS",Object.keys(unusedTable))();unusedTable=(0,_webgl.getDebugTableForProgramConfiguration)(this.vertexArray.configuration);_webgl.log.table(logLevel,vertexArray)();_webgl.log.table(logLevel,uniformTable)();_webgl.log.table(logLevel+1,unusedTable)();framebuffer&&framebuffer.log({logLevel:2,message:"Rendered to ".concat(framebuffer.id)});_webgl.log.groupEnd(2,"\x3e\x3e\x3e DRAWING MODEL ".concat(this.id))()}}}]);return Model}();
