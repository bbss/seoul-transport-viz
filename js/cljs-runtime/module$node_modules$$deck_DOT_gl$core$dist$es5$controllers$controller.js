...
_log=global(require("module$node_modules$$deck_DOT_gl$core$dist$es5$utils$log")),_assert=global(require("module$node_modules$$deck_DOT_gl$core$dist$es5$utils$assert")),NO_TRANSITION_PROPS={transitionDuration:0},JSCompiler_object_inline_WHEEL_6612=["wheel"],JSCompiler_object_inline_PAN_6613=["panstart","panmove","panend"],JSCompiler_object_inline_PINCH_6614=["pinchstart","pinchmove","pinchend"],JSCompiler_object_inline_DOUBLE_TAP_6615=["doubletap"],JSCompiler_object_inline_KEYBOARD_6616=["keydown"];
...
!0:_props$doubleClickZoo;var _props$touchZoom=props.touchZoom;_props$touchZoom=void 0===_props$touchZoom?!0:_props$touchZoom;var _props$touchRotate=props.touchRotate;_props$touchRotate=void 0===_props$touchRotate?!1:_props$touchRotate;props=props.keyboard;props=void 0===props?!0:props;var isInteractive=!!this.onViewStateChange;this.toggleEvents(JSCompiler_object_inline_WHEEL_6612,isInteractive&&_props$scrollZoom);this.toggleEvents(JSCompiler_object_inline_PAN_6613,isInteractive&&(_props$dragPan||
_props$dragRotate));this.toggleEvents(JSCompiler_object_inline_PINCH_6614,isInteractive&&(_props$touchZoom||_props$touchRotate));this.toggleEvents(JSCompiler_object_inline_DOUBLE_TAP_6615,isInteractive&&_props$doubleClickZoo);this.toggleEvents(JSCompiler_object_inline_KEYBOARD_6616,isInteractive&&props);this.scrollZoom=_props$scrollZoom;this.dragPan=_props$dragPan;this.dragRotate=_props$dragRotate;this.doubleClickZoom=_props$doubleClickZoo;this.touchZoom=_props$touchZoom;this.touchRotate=_props$touchRotate;
