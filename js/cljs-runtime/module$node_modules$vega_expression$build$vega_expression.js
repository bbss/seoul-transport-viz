...
function parsePrimaryExpression(){if(match("(")){expect("(");var type=parseExpression();expect(")");return type}if(match("[")){type=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),type.push(null)):(type.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_8119=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_8119.elements=type;return JSCompiler_object_inline_value_8119}if(match("{")){type=[];JSCompiler_object_inline_value_8119=
{};var JSCompiler_object_inline_literal_8120=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_8121=lookahead;if(3===JSCompiler_object_inline_value_8121.type){var JSCompiler_object_inline_literal_8122=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_8121=parseConditionalExpression();JSCompiler_object_inline_value_8121=finishProperty("init",JSCompiler_object_inline_literal_8122,JSCompiler_object_inline_value_8121)}else 2===
JSCompiler_object_inline_value_8121.type||7===JSCompiler_object_inline_value_8121.type?(throwUnexpected(JSCompiler_object_inline_value_8121),JSCompiler_object_inline_value_8121=void 0):(JSCompiler_object_inline_literal_8122=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_8121=parseConditionalExpression(),JSCompiler_object_inline_value_8121=finishProperty("init",JSCompiler_object_inline_literal_8122,JSCompiler_object_inline_value_8121));JSCompiler_object_inline_literal_8122="Identifier"===
JSCompiler_object_inline_value_8121.key.type?JSCompiler_object_inline_value_8121.key.name:JSCompiler_object_inline_literal_8120(JSCompiler_object_inline_value_8121.key.value);JSCompiler_object_inline_literal_8122="$"+JSCompiler_object_inline_literal_8122;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_8119,JSCompiler_object_inline_literal_8122)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_8119[JSCompiler_object_inline_literal_8122]=
!0;type.push(JSCompiler_object_inline_value_8121);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_8119=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_8119.properties=type;return JSCompiler_object_inline_value_8119}type=lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_8119=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),
JSCompiler_object_inline_value_8119=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_8119=finishLiteral(type);else if(5===type)type=lex(),type.value=null,JSCompiler_object_inline_value_8119=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_8119=source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_8119,
"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_8120=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_8122=JSCompiler_object_inline_value_8121=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_8119=source[index$jscomp$0++],JSCompiler_object_inline_literal_8120+=JSCompiler_object_inline_value_8119,"\\"===JSCompiler_object_inline_value_8119)JSCompiler_object_inline_value_8119=source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_8119.charCodeAt(0))&&
throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_8120+=JSCompiler_object_inline_value_8119;else if(isLineTerminator(JSCompiler_object_inline_value_8119.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_8121)"]"===JSCompiler_object_inline_value_8119&&(JSCompiler_object_inline_value_8121=!1);else if("/"===JSCompiler_object_inline_value_8119){JSCompiler_object_inline_literal_8122=!0;break}else"["===JSCompiler_object_inline_value_8119&&
(JSCompiler_object_inline_value_8121=!0);JSCompiler_object_inline_literal_8122||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_8119=JSCompiler_object_inline_literal_8120.substr(1,JSCompiler_object_inline_literal_8120.length-2);for(value=JSCompiler_object_inline_literal_8122="";index$jscomp$0<length;){JSCompiler_object_inline_value_8121=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_8121.charCodeAt(0)))break;++index$jscomp$0;"\\"===
JSCompiler_object_inline_value_8121&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_8121,JSCompiler_object_inline_literal_8122+=JSCompiler_object_inline_value_8121)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_8121=value;value=testRegExp(JSCompiler_object_inline_value_8119,JSCompiler_object_inline_value_8121);JSCompiler_object_inline_value_8119=finishLiteral({literal:JSCompiler_object_inline_literal_8120+
