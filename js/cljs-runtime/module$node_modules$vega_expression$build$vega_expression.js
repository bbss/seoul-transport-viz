...
function parsePrimaryExpression(){if(match("(")){expect("(");var type=parseExpression();expect(")");return type}if(match("[")){type=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),type.push(null)):(type.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_8216=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_8216.elements=type;return JSCompiler_object_inline_value_8216}if(match("{")){type=[];JSCompiler_object_inline_value_8216=
{};var JSCompiler_object_inline_literal_8217=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_8218=lookahead;if(3===JSCompiler_object_inline_value_8218.type){var JSCompiler_object_inline_literal_8219=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_8218=parseConditionalExpression();JSCompiler_object_inline_value_8218=finishProperty("init",JSCompiler_object_inline_literal_8219,JSCompiler_object_inline_value_8218)}else 2===
JSCompiler_object_inline_value_8218.type||7===JSCompiler_object_inline_value_8218.type?(throwUnexpected(JSCompiler_object_inline_value_8218),JSCompiler_object_inline_value_8218=void 0):(JSCompiler_object_inline_literal_8219=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_8218=parseConditionalExpression(),JSCompiler_object_inline_value_8218=finishProperty("init",JSCompiler_object_inline_literal_8219,JSCompiler_object_inline_value_8218));JSCompiler_object_inline_literal_8219="Identifier"===
JSCompiler_object_inline_value_8218.key.type?JSCompiler_object_inline_value_8218.key.name:JSCompiler_object_inline_literal_8217(JSCompiler_object_inline_value_8218.key.value);JSCompiler_object_inline_literal_8219="$"+JSCompiler_object_inline_literal_8219;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_8216,JSCompiler_object_inline_literal_8219)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_8216[JSCompiler_object_inline_literal_8219]=
!0;type.push(JSCompiler_object_inline_value_8218);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_8216=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_8216.properties=type;return JSCompiler_object_inline_value_8216}type=lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_8216=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),
JSCompiler_object_inline_value_8216=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_8216=finishLiteral(type);else if(5===type)type=lex(),type.value=null,JSCompiler_object_inline_value_8216=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_8216=source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_8216,
"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_8217=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_8219=JSCompiler_object_inline_value_8218=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_8216=source[index$jscomp$0++],JSCompiler_object_inline_literal_8217+=JSCompiler_object_inline_value_8216,"\\"===JSCompiler_object_inline_value_8216)JSCompiler_object_inline_value_8216=source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_8216.charCodeAt(0))&&
throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_8217+=JSCompiler_object_inline_value_8216;else if(isLineTerminator(JSCompiler_object_inline_value_8216.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_8218)"]"===JSCompiler_object_inline_value_8216&&(JSCompiler_object_inline_value_8218=!1);else if("/"===JSCompiler_object_inline_value_8216){JSCompiler_object_inline_literal_8219=!0;break}else"["===JSCompiler_object_inline_value_8216&&
(JSCompiler_object_inline_value_8218=!0);JSCompiler_object_inline_literal_8219||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_8216=JSCompiler_object_inline_literal_8217.substr(1,JSCompiler_object_inline_literal_8217.length-2);for(value=JSCompiler_object_inline_literal_8219="";index$jscomp$0<length;){JSCompiler_object_inline_value_8218=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_8218.charCodeAt(0)))break;++index$jscomp$0;"\\"===
JSCompiler_object_inline_value_8218&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_8218,JSCompiler_object_inline_literal_8219+=JSCompiler_object_inline_value_8218)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_8218=value;value=testRegExp(JSCompiler_object_inline_value_8216,JSCompiler_object_inline_value_8218);JSCompiler_object_inline_value_8216=finishLiteral({literal:JSCompiler_object_inline_literal_8217+
JSCompiler_object_inline_literal_8219,value:value,regex:{pattern:JSCompiler_object_inline_value_8216,flags:JSCompiler_object_inline_value_8218},start:type,end:index$jscomp$0});peek()}else throwUnexpected(lex())}return JSCompiler_object_inline_value_8216}function parsePostfixExpression(){var expr;for(expr=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=lookahead.start;var args=lex();3===args.type||4===args.type||1===args.type||5===args.type||throwUnexpected(args);args=finishIdentifier(args.value);
