...
_createClass2=global(require("module$node_modules$$babel$runtime$helpers$createClass")),_possibleConstructorReturn2=global(require("module$node_modules$$babel$runtime$helpers$possibleConstructorReturn")),_getPrototypeOf2=global(require("module$node_modules$$babel$runtime$helpers$getPrototypeOf")),_get2=global(require("module$node_modules$$babel$runtime$helpers$get")),_inherits2=global(require("module$node_modules$$babel$runtime$helpers$inherits")),_core=require("module$node_modules$$luma_DOT_gl$core$dist$es5$index"),
_core2=require("module$node_modules$$deck_DOT_gl$core$dist$es5$index"),_gpuGridAggregator=global(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$gpu_grid_aggregation$gpu_grid_aggregator")),_aggregationOperationUtils=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$aggregation_operation_utils"),_colorUtils=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$color_utils"),_gpuGridCellLayer=global(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$gpu_grid_layer$gpu_grid_cell_layer")),
_gridAggregator=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$cpu_grid_layer$grid_aggregator");global=global(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$grid_aggregation_layer"));var _gridAggregationUtils=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$grid_aggregation_utils");require={colorDomain:null,colorRange:_colorUtils.defaultColorRange,getColorWeight:{type:"accessor",value:function(x){return 1}},colorAggregation:"SUM",
elevationDomain:null,elevationRange:[0,1E3],getElevationWeight:{type:"accessor",value:function(x){return 1}},elevationAggregation:"SUM",elevationScale:{type:"number",min:0,value:1},cellSize:{type:"number",min:1,max:1E3,value:1E3},coverage:{type:"number",min:0,max:1,value:1},getPosition:{type:"accessor",value:function(x){return x.position}},extruded:!1,material:!0};var DIMENSIONS={data:{props:["cellSize","colorAggregation","elevationAggregation"]}};global=function(_GridAggregationLayer){function GPUGridLayer(){(0,
_classCallCheck2["default"])(this,GPUGridLayer);return(0,_possibleConstructorReturn2["default"])(this,(0,_getPrototypeOf2["default"])(GPUGridLayer).apply(this,arguments))}(0,_inherits2["default"])(GPUGridLayer,_GridAggregationLayer);(0,_createClass2["default"])(GPUGridLayer,[{key:"initializeState",value:function(){var _attributeManager$add,gl=this.context.gl,isSupported=_gpuGridAggregator["default"].isSupported(gl);isSupported||_core2.log.error("GPUGridLayer is not supported on this browser, use GridLayer instead")();
(0,_get2["default"])((0,_getPrototypeOf2["default"])(GPUGridLayer.prototype),"initializeState",this).call(this,{dimensions:DIMENSIONS});this.setState({gpuAggregation:!0,projectPoints:!1,isSupported:isSupported,weights:{color:{needMin:!0,needMax:!0,combineMaxMin:!0,maxMinBuffer:new _core.Buffer(gl,{byteLength:16,accessor:{size:4,type:5126,divisor:1}})},elevation:{needMin:!0,needMax:!0,combineMaxMin:!0,maxMinBuffer:new _core.Buffer(gl,{byteLength:16,accessor:{size:4,type:5126,divisor:1}})}},positionAttributeName:"positions"});
...
weights.color;weights=weights.elevation;var colorRange=(0,_colorUtils.colorRangeToFlatArray)(this.props.colorRange);return new (this.getSubLayerClass("gpu-grid-cell",_gpuGridCellLayer["default"]))({gridSize:[numCol,numRow],gridOrigin:gridOrigin,gridOffset:[_this$state4.xOffset,_this$state4.yOffset],colorRange:colorRange,elevationRange:elevationRange,colorDomain:colorDomain,elevationDomain:_this$props,cellSize:cellSizeMeters,coverage:coverage,material:material,elevationScale:elevationScale,extruded:extruded},
this.getSubLayerProps({id:"gpu-grid-cell"}),{data:{attributes:{colors:color.aggregationBuffer,elevations:weights.aggregationBuffer}},colorMaxMinBuffer:color.maxMinBuffer,elevationMaxMinBuffer:weights.maxMinBuffer,numInstances:numCol*numRow})}},{key:"finalizeState",value:function(){var _this$state$weights=this.state.weights;[_this$state$weights.color,_this$state$weights.elevation].forEach(function(weight){var aggregationBuffer=weight.aggregationBuffer;weight.maxMinBuffer["delete"]();if(aggregationBuffer)aggregationBuffer["delete"]()});
(0,_get2["default"])((0,_getPrototypeOf2["default"])(GPUGridLayer.prototype),"finalizeState",this).call(this)}},{key:"updateAggregationState",value:function(opts){var props=opts.props,cellSize=props.cellSize,coordinateSystem=props.coordinateSystem,viewport=this.context.viewport,cellSizeChanged=opts.oldProps.cellSize!==cellSize;props=this.state.dimensions;var positionsChanged=this.isAttributeChanged("positions"),attributesChanged=positionsChanged||this.isAttributeChanged(),boundingBox=this.state.boundingBox;
positionsChanged&&(boundingBox=(0,_gridAggregationUtils.getBoundingBox)(this.getAttributes(),this.getNumInstances()),this.setState({boundingBox:boundingBox}));if(positionsChanged||cellSizeChanged)boundingBox=(0,_gridAggregationUtils.getGridParams)(boundingBox,cellSize,viewport,coordinateSystem),cellSize=boundingBox.gridOffset,coordinateSystem=boundingBox.translation,viewport=boundingBox.width,cellSizeChanged=boundingBox.height,positionsChanged=boundingBox.numCol,boundingBox=boundingBox.numRow,this.allocateResources(boundingBox,
positionsChanged),this.setState({gridOffset:cellSize,translation:coordinateSystem,gridOrigin:[-1*coordinateSystem[0],-1*coordinateSystem[1]],width:viewport,height:cellSizeChanged,numCol:positionsChanged,numRow:boundingBox});(props=attributesChanged||this.isAggregationDirty(opts,{dimension:props.data,compareAll:!0}))&&this._updateAccessors(opts);this.setState({aggregationDataDirty:props})}},{key:"_updateAccessors",value:function(opts){opts=opts.props;var elevationAggregation=opts.elevationAggregation,
_this$state$weights2=this.state.weights,elevation=_this$state$weights2.elevation;_this$state$weights2.color.operation=_aggregationOperationUtils.AGGREGATION_OPERATION[opts.colorAggregation];elevation.operation=_aggregationOperationUtils.AGGREGATION_OPERATION[elevationAggregation]}}]);return GPUGridLayer}(global["default"]);exports["default"]=global;global.layerName="GPUGridLayer";global.defaultProps=require}
