...
leftOffsets[i$jscomp$0]=x,x+=MISSING_CHAR_WIDTH)}JSCompiler_object_inline_leftOffsets_6643=leftOffsets;JSCompiler_object_inline_rowWidth_6644=x;JSCompiler_object_inline_rowHeight_6645=rowHeight;rows=JSCompiler_object_inline_rowWidth_6644;x=JSCompiler_object_inline_rowHeight_6645;rowHeight=JSCompiler_object_inline_leftOffsets_6643;i$jscomp$0=!0;var _didIteratorError3=!1,_iteratorError3=void 0;try{for(var _iterator3=rowHeight[Symbol.iterator](),_step3;!(i$jscomp$0=(_step3=_iterator3.next()).done);i$jscomp$0=
!0){var x$jscomp$0=_step3.value;result[lineStartIndex++]={x:x$jscomp$0,y:rowOffsetTop+x/2,rowWidth:rows}}}catch(err){_didIteratorError3=!0,_iteratorError3=err}finally{try{if(!i$jscomp$0&&null!=_iterator3["return"])_iterator3["return"]()}finally{if(_didIteratorError3)throw _iteratorError3;}}rowOffsetTop+=x*lineHeight;size[0]=autoWrappingEnabled?maxWidth:Math.max(size[0],rows)}}catch(err$421){_didIteratorError2=!0,_iteratorError2=err$421}finally{try{if(!line&&null!=_iterator2["return"])_iterator2["return"]()}finally{if(_didIteratorError2)throw _iteratorError2;
