...
oldCenterToPoint);_didIteratorError=_iteratorError*_iteratorError;zMin=oldCenterToPoint-_iteratorError;_iteratorNormalCompletion.x=(_iteratorError*_iteratorNormalCompletion.x+zMin*currentPos.x)/oldCenterToPoint;_iteratorNormalCompletion.y=(_iteratorError*_iteratorNormalCompletion.y+zMin*currentPos.y)/oldCenterToPoint;_iteratorNormalCompletion.z=(_iteratorError*_iteratorNormalCompletion.z+zMin*currentPos.z)/oldCenterToPoint}}}catch(err$398){xMin=!0,yMin=err$398}finally{try{if(!zMax&&null!=_iterator2["return"])_iterator2["return"]()}finally{if(xMin)throw yMin;
