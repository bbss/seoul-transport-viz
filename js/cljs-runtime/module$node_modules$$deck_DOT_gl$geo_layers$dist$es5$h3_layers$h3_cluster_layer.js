...
!0);iterable=!0;var _didIteratorError2=!1,_iteratorError2=void 0;try{for(var _iterator2=multiPolygon[Symbol.iterator](),_step2;!(iterable=(_step2=_iterator2.next()).done);iterable=!0)_ref.push(this.getSubLayerRow({polygon:_step2.value},object,data.index))}catch(err){_didIteratorError2=!0,_iteratorError2=err}finally{try{if(!iterable&&null!=_iterator2["return"])_iterator2["return"]()}finally{if(_didIteratorError2)throw _iteratorError2;}}}}catch(err$405){_didIteratorError=!0,_iteratorError=err$405}finally{try{if(!_iteratorNormalCompletion&&
