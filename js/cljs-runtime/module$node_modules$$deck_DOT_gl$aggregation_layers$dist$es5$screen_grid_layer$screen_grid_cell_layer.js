shadow$provide.module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$screen_grid_layer$screen_grid_cell_layer=function(global,require,module,exports){global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports["default"]=void 0;var _classCallCheck2=global(require("module$node_modules$$babel$runtime$helpers$classCallCheck")),_createClass2=global(require("module$node_modules$$babel$runtime$helpers$createClass")),
_possibleConstructorReturn2=global(require("module$node_modules$$babel$runtime$helpers$possibleConstructorReturn")),_getPrototypeOf2=global(require("module$node_modules$$babel$runtime$helpers$getPrototypeOf")),_get2=global(require("module$node_modules$$babel$runtime$helpers$get")),_inherits2=global(require("module$node_modules$$babel$runtime$helpers$inherits")),_core=require("module$node_modules$$luma_DOT_gl$core$dist$es5$index"),_core2=require("module$node_modules$$deck_DOT_gl$core$dist$es5$index"),
_colorUtils=require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$utils$color_utils"),_screenGridLayerVertex=global(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$screen_grid_layer$screen_grid_layer_vertex_glsl")),_screenGridLayerFragment=global(require("module$node_modules$$deck_DOT_gl$aggregation_layers$dist$es5$screen_grid_layer$screen_grid_layer_fragment_glsl")),DEFAULT_MINCOLOR=[0,0,0,0],DEFAULT_MAXCOLOR=[0,255,0,255],COLOR_PROPS=["minColor","maxColor",
"colorRange","colorDomain"];require={cellSizePixels:{value:100,min:1},cellMarginPixels:{value:2,min:0,max:5},colorDomain:null,colorRange:_colorUtils.defaultColorRange};global=function(_Layer){function ScreenGridCellLayer(){(0,_classCallCheck2["default"])(this,ScreenGridCellLayer);return(0,_possibleConstructorReturn2["default"])(this,(0,_getPrototypeOf2["default"])(ScreenGridCellLayer).apply(this,arguments))}(0,_inherits2["default"])(ScreenGridCellLayer,_Layer);(0,_createClass2["default"])(ScreenGridCellLayer,
[{key:"getShaders",value:function(){return{vs:_screenGridLayerVertex["default"],fs:_screenGridLayerFragment["default"],modules:[_core2.picking]}}},{key:"initializeState",value:function(){var gl=this.context.gl;this.getAttributeManager().addInstanced({instancePositions:{size:3,update:this.calculateInstancePositions},instanceCounts:{size:4,noAlloc:!0}});this.setState({model:this._getModel(gl)})}},{key:"shouldUpdateState",value:function(_ref){return _ref.changeFlags.somethingChanged}},{key:"updateState",
value:function(_ref2){var oldProps=_ref2.oldProps,props=_ref2.props;_ref2=_ref2.changeFlags;(0,_get2["default"])((0,_getPrototypeOf2["default"])(ScreenGridCellLayer.prototype),"updateState",this).call(this,{oldProps:oldProps,props:props,changeFlags:_ref2});var attributeManager=this.getAttributeManager();props.numInstances!==oldProps.numInstances?attributeManager.invalidateAll():oldProps.cellSizePixels!==props.cellSizePixels&&attributeManager.invalidate("instancePositions");this._updateUniforms(oldProps,
